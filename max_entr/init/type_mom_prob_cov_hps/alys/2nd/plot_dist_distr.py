...
ax[0,0].set_xlim(-7,165)
ax[0,0].set_xlabel('Reference Distance',fontsize=size)
...
ax[0,1].set_xlim(0.4,2.3)
ax[0,1].set_xlabel('Reference Logarithmic Distance',fontsize=size)
...
ax[1,0].set_xlim(-7,165)
ax[1,0].set_xlabel('Fitted Distance',fontsize=size)
...
ax[1,1].set_xlim(0.4,2.3)
ax[1,1].set_xlabel('Fitted Logarithmic Distance',fontsize=size)
