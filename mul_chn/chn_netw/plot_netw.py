...
figwth=0.87
cbarwth=0.03
axlabels=['Degree of Each Node','Mean of Degree']
...
for i in range(nT):
    for j in range(2):
        ...
        for k in range(nmd):
            rgb=cmap(k/(nmd-1))
            ax.plot(x[k,i,:,j],p[k,i,:,j],color=rgb,linewidth=wth)
        ax.autoscale()
        ax.minorticks_on()
        ...
        ax.set_xlabel(axlabels[j],fontsize=size)
        if j==1:
            ax.set_xlabel('%s\nat %i K'%(axlabels[j],Ts[i]),fontsize=size)
        if i==0:
...
plt.savefig(f'{figname}_deg_1.png',format='png')
plt.savefig(f'{figname}_deg_1.pdf',format='pdf')
# plt.show()
...
for i in range(nmd):
    for j in range(2):
        ...
        for k in range(nT):
            rgb=cmap(k/(nT-1))
            ax.plot(x[i,k,:,j],p[i,k,:,j],color=rgb,linewidth=wth)
        ax.autoscale()
        ax.minorticks_on()
        ax.tick_params(axis='both',which='major',direction='in',width=wth,length=lenmaj,labelsize=size)
        ax.tick_params(axis='both',which='minor',direction='in',width=wth,length=lenmin,labelsize=size)
        ...
        ax.set_xlabel(axlabels[j],fontsize=size)
        if j==1:
            ax.set_xlabel('%s\nof Flu.=%.2f'%(axlabels[j],10**rg_flu[i]),fontsize=size)
        if i==0:
            ax.set_ylabel('Probability Density',fontsize=size)
...
plt.savefig(f'{figname}_deg_2.png',format='png')
plt.savefig(f'{figname}_deg_2.pdf',format='pdf')
# plt.show()
...
figwth=0.87
cbarwth=0.03
axlabels=['BC of Each Node','Mean of BC','Deviation of BC','Skewness of BC']
color=['#105186','#3D86B6','#67B3DA','#9DDAF2']
nodes=[0/3,1/3,2/3,3/3]
cmap=LinearSegmentedColormap.from_list('custom_cmap',list(zip(nodes,color)))
# cmap=plt.cm.rainbow
...
for i in range(nT):
    for j in range(4):
        ...
        for k in range(nmd):
            rgb=cmap(k/(nmd-1))
            ax.plot(x[k,i,:,j+2],p[k,i,:,j+2],color=rgb,linewidth=wth)
        ax.autoscale()
        ax.minorticks_on()
        ax.tick_params(axis='both',which='major',direction='in',width=wth,length=lenmaj,labelsize=size)
        ax.tick_params(axis='both',which='minor',direction='in',width=wth,length=lenmin,labelsize=size)
...
plt.savefig(f'{figname}_betw_cent_1.png',format='png')
plt.savefig(f'{figname}_betw_cent_1.pdf',format='pdf')
# plt.show()
...
for i in range(nmd):
    for j in range(4):
        ...
        for k in range(nT):
            rgb=cmap(k/(nT-1))
            ax.plot(x[i,k,:,j+2],p[i,k,:,j+2],color=rgb,linewidth=wth)
        ax.autoscale()
        ax.minorticks_on()
        ax.tick_params(axis='both',which='major',direction='in',width=wth,length=lenmaj,labelsize=size)
        ax.tick_params(axis='both',which='minor',direction='in',width=wth,length=lenmin,labelsize=size)
...
plt.savefig(f'{figname}_betw_cent_2.png',format='png')
plt.savefig(f'{figname}_betw_cent_2.pdf',format='pdf')
# plt.show()

fig,axs=plt.subplots(5,nT,figsize=(15,15))
wth=2
size=20
lenmaj=15
lenmin=8
...
figwth=0.87
cbarwth=0.03
axlabels=['Clustering Coefficient','Mean Path Length','Relative Clustering Coefficient','Relative Mean Path Length','Small-world Coefficient']
color=['#105186','#3D86B6','#67B3DA','#9DDAF2']
nodes=[0/3,1/3,2/3,3/3]
cmap=LinearSegmentedColormap.from_list('custom_cmap',list(zip(nodes,color)))
# cmap=plt.cm.rainbow
...
for i in range(nT):
    for j in range(5):
        ...
        for k in range(nmd):
            rgb=cmap(k/(nmd-1))
            ax.plot(x[k,i,:,j+6],p[k,i,:,j+6],color=rgb,linewidth=wth)
        ax.autoscale()
        ax.minorticks_on()
        ax.tick_params(axis='both',which='major',direction='in',width=wth,length=lenmaj,labelsize=size)
        ax.tick_params(axis='both',which='minor',direction='in',width=wth,length=lenmin,labelsize=size)
...
plt.savefig(f'{figname}_sml_wrld_1.png',format='png')
plt.savefig(f'{figname}_sml_wrld_1.pdf',format='pdf')
# plt.show()

fig,axs=plt.subplots(5,nmd,figsize=(15,15))
wth=2
size=20
lenmaj=15
lenmin=8
...
for i in range(nmd):
    for j in range(5):
        ...
        for k in range(nT):
            rgb=cmap(k/(nT-1))
            ax.plot(x[i,k,:,j+6],p[i,k,:,j+6],color=rgb,linewidth=wth)
        ax.autoscale()
        ax.minorticks_on()
        ax.tick_params(axis='both',which='major',direction='in',width=wth,length=lenmaj,labelsize=size)
        ax.tick_params(axis='both',which='minor',direction='in',width=wth,length=lenmin,labelsize=size)
...
plt.savefig(f'{figname}_sml_wrld_2.png',format='png')
plt.savefig(f'{figname}_sml_wrld_2.pdf',format='pdf')
# plt.show()